        ...
        <form action="{{ route('admin.packages.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex flex-col md:flex-row gap-6">
                ...
                <div class="flex-1">
                    ...
                    <input
                        ...
                        name="offer_limit"
                        min="1"
                        value="{{ old('offer_limit') }}"
                        required
                        placeholder="1, 2, 5, 10 or 999999 for Unlimited"
                        class="mt-1.5 block w-full px-3 py-2 border border-slate-850 rounded-xl bg-slate-950/60 text-white">
                </div>
            ...
            <div>
                ...
                <textarea
                    ...
                    name="description"
                    rows="4"
                    class="mt-1.5 block w-full px-3 py-2 border border-slate-850 rounded-xl bg-slate-950/60 text-white">{{ old('description') }}</textarea>
            </div>
